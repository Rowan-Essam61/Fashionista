    ...
    <div class="form">
        ...
        <div class="container">
             <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" style="height: 1000px;">
                 ...
                 <textarea name="tshirtdesc" id="description" cols="50" rows="5" required></textarea>
                 <br>
                 <h4>TShirt Price</h4>
                <input type="number" name="tshirtprice" id="price" required>
                <h4>TShirt Quantity</h4>
                <input type="number" name="tshirtquantity" id="quantity" required>
                <h4>TShirt Photo</h4>
                <input type="file" name="tshirtphoto" id="photo" required>
                <h4>TShirt Size</h4>
                <input type="text" name="tshirtsize" id="size" required>
                <br>
                <input type="submit" value="Add" class="submit" required>
            </form>
            <?php
                $description=$_POST['tshirtdesc'];
                $price=$_POST['tshirtprice'];
                $quantity=$_POST['tshirtquantity'];
                $photo="../images/Tshirts/" .$_POST['tshirtphoto'];
                ...
                try{
                    ...
                    VALUES ('$description',$price,5,$quantity,'$photo','$size')";
                    $conn -> exec($sql);
               } 
