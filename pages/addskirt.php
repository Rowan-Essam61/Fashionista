    ...
    <div class="form">
        ...
        <div class="container">
             <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" style="height: 1000px;">
                 <h4>Skirt description</h4>
                 <textarea name="skirtdesc" id="description" cols="50" rows="5" required></textarea>
                 <br>
                 <h4>Skirt Price</h4>
                <input type="number" name="skirtprice" id="price" required>
                <h4>Skirt Quantity</h4>
                <input type="number" name="skirtquantity" id="quantity" required>
                <h4>Skirt Photo</h4>
                <input type="file" name="skirtphoto" id="photo" required>
                <h4>Skirt Size</h4>
                <input type="text" name="skirtsize" id="size" required>
                <br>
                <input type="submit" value="Add" class="submit" required>
            </form>
            <?php
                $description=$_POST['skirtdesc'];
                $price=$_POST['skirtprice'];
                $quantity=$_POST['skirtquantity'];
                $photo="../images/skirts/" .$_POST['skirtphoto'];
                $size=$_POST['skirtsize'];
                ...
                try{
                    ...
                    VALUES ('$description',$price,3,$quantity,'$photo','$size')";
                    $conn -> exec($sql);
               }
