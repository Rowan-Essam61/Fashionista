    ...
    <div class="form">
        ...
        <div class="container">
             <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" style="height: 1000px;">
                 ...
                 <textarea name="blousedesc" id="description" cols="50" rows="5" required></textarea>
                 <br>
                 <h4>Blouse Price</h4>
                <input type="number" name="blouseprice" id="price" required>
                <h4>Blouse Quantity</h4>
                <input type="number" name="blousequantity" id="quantity" required>
                <h4>Blouse Photo</h4>
                <input type="file" name="blousephoto" id="photo" required>
                <h4>Blouse Size</h4>
                <input type="text" name="blousesize" id="size" required>
                <br>
                <input type="submit" value="Add" class="submit" required>
            </form>
            <?php
                $description=$_POST['blousedesc'];
                $price=$_POST['blouseprice'];
                $quantity=$_POST['blousequantity'];
                $photo="../images/Blooses/" .$_POST['blousephoto'];
                $size=$_POST['blousesize'];
               ...
               try{
                    ...
                    VALUES ('$description',$price,4,$quantity,'$photo','$size')";
                    $conn -> exec($sql);
               }
